...
Input: data/FIFA-2026/FIFA Group Stage Responses.xlsx (two tabs)
  - Form Responses 1: Google Form wide format (12 entries)
  - Entries: Website compact format (42 entries)

Output:
  - data/FIFA-2026/GroupStage-Predictions-Clean.csv (no emails)
  - data/FIFA-2026/GroupStage-Contacts.csv (Name + Email)
  - data/FIFA-2026/GroupStage-Predictions-Table.md (markdown table)
  - active-contest/predictions-group-stage-table.md (copy)
"""
...
XLSX_PATH = os.path.join(PROJECT_ROOT, "data", "FIFA-2026", "FIFA Group Stage Responses.xlsx")
SUPPLEMENTAL_CSV = os.path.join(PROJECT_ROOT, "data", "FIFA-2026", "Group-stage-adds.csv")
OUT_DIR = os.path.join(PROJECT_ROOT, "data", "FIFA-2026")
...
def main():
    ...
    # Write contacts CSV
    contacts_path = os.path.join(OUT_DIR, "GroupStage-Contacts.csv")
    ...
    table_path = os.path.join(OUT_DIR, "GroupStage-Predictions-Table.md")
    with open(table_path, "w") as f:
        f.write(table_md)
    print(f"\nWrote {table_path}")

    # Copy to active-contest
    active_table_path = os.path.join(ACTIVE_CONTEST_DIR, "predictions-group-stage-table.md")
    shutil.copy2(table_path, active_table_path)
    print(f"Copied to {active_table_path}")
