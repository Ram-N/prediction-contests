...
## Group 1: The "Group of Death" — and a Surprising Consensus

Group 1 is the group that got the dramatic nickname before a single ball was bowled: **India, South Africa, West Indies, Zimbabwe** — four group-stage winners, all unbeaten coming in.
...
## Group 2: Beautiful Chaos

Now here's where things get interesting. **Pakistan, England, Sri Lanka, New Zealand** — all playing in Sri Lanka, all entering with a loss on their record, none of them dominant.
...
All four models agree Sri Lanka are hurt. The loss of Matheesha Pathirana (pace, death overs) and Wanindu Hasaranga (leg-spin, control) strips them of their two most potent weapons. Three of the four AIs effectively eliminated Sri Lanka from the top two. Only Claude picked them to advance — at a confidence level of just 30%, the lowest of any prediction in the entire exercise.

What Claude saw that others didn't: Pathum Nissanka's batting form (multiple centuries, tournament-best NRR at +3.125) and the home-crowd factor. Maheesh Theekshana remains a genuine threat on spinning Colombo tracks. It's a brave pick — and Claude essentially admitted it by the 30% confidence.

### The Pakistan "Colombo Residency" Argument

Pakistan played their entire group stage in Colombo. Gemini made this the centerpiece of its Group 2 analysis — calling it a "Colombo Residency" that gives Pakistan intimate knowledge of pitch behavior, dew patterns, and atmospheric conditions. Their spin-heavy bowling attack (Usman Tariq and Shadab Khan taking 15+ wickets between them) is explicitly designed for slow, turning tracks. Gemini picked Pakistan 1st at 72% confidence — the most decisive Group 2 call of any model.

ChatGPT saw the same Pakistan advantage but put New Zealand ahead of them. Why? Venue continuity — New Zealand play *all three* of their Super 8 matches at R. Premadasa Stadium, and they've explicitly adapted their game plan for Colombo's slower surfaces. ChatGPT also cited a favorable recent head-to-head trend (New Zealand have won 10 of 15 T20Is vs Pakistan since 2024).

### The England Question

England are the one team everyone has an opinion about — and none of them agree. They're Perplexity's first pick, Gemini's second pick, Claude's first pick, and ChatGPT doesn't advance them at all.

The bull case: Jos Buttler and Phil Salt in the powerplay are feared worldwide. Harry Brook's aggressive captaincy is a new gear. Jofra Archer's return is a massive bowling boost. England's batting depth is the best in the group on paper.

The bear case: England's spin bowling is paper-thin. If pitches in Kandy and Colombo offer significant turn, they'll have to rely on part-timers. They lost to West Indies in the group stage. And their recent form in Asian conditions has been mixed.
...
- [The prompt that was used]({{ site.baseurl }}/t20-2026/ai-super8-prompt) — exactly what each AI was asked
- [ChatGPT Deep Research]({{ site.baseurl }}/t20-2026/ai-super8-chatgpt) — NZ 1st, PAK 2nd
- [Claude Opus 4.6]({{ site.baseurl }}/t20-2026/ai-super8-claude) — ENG 1st, SL 2nd
- [Gemini Deep Research]({{ site.baseurl }}/t20-2026/ai-super8-gemini) — PAK 1st, ENG 2nd
- [Perplexity (GPT-5.1)]({{ site.baseurl }}/t20-2026/ai-super8-perplexity) — ENG 1st, PAK 2nd
