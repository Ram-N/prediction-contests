...
**[Submit your predictions now!](https://forms.gle/y5YWKUnzxvQACuJP8)**

Or follow these steps:

1. Visit the [entry form](https://forms.gle/y5YWKUnzxvQACuJP8)
2. Read the [contest rules](/prediction-contests/nfl-2025/rules) carefully
3. Submit your predictions before the Divisional Round begins

## Scoring

This contest uses a logarithmic scoring system that rewards confident correct predictions. Lower total score wins!

See the full [scoring details](/prediction-contests/nfl-2025/rules#scoring-system) in the rules.
