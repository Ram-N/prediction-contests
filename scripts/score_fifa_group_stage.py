...
Input:
  - active-contest/data/predictions/GroupStage-Predictions-Clean.csv (predictions)
...
PREDICTIONS_CSV = os.path.join(
    PROJECT_ROOT, "active-contest", "data", "predictions", "GroupStage-Predictions-Clean.csv"
)
