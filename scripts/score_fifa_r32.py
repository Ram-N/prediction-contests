...
Input:
  - active-contest/data/predictions/FIFA-2026-R32-predictions.csv (predictions)
...
PREDICTIONS_CSV = os.path.join(
    PROJECT_ROOT, "pii-data", "FIFA-2026", "raw-predictions", "FIFA-2026-R32-predictions.csv"
)
...
def build_name_rename_map(canonical_names, email_recon, predictions_csv):
    ...
    gs_contacts_csv = os.path.join(
        PROJECT_ROOT, "pii-data", "FIFA-2026", "GroupStage-Contacts.csv"
    )
